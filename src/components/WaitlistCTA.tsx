        ...
        <div className="bg-coral rounded-3xl overflow-hidden">
          <div className="flex flex-col md:flex-row items-center">
            ...
            <div className="w-full md:w-1/2 h-64 md:h-auto">
              <img 
                src="https://images.unsplash.com/photo-1583116527329-7ea3bc587a19?auto=format&fit=crop&q=80&w=800&ixlib=rb-4.0.3" 
                alt="Tourist in China" 
            ...
            <div className="w-full md:w-1/2 p-8 md:p-12 bg-gradient-to-r from-coral to-coral/90 text-white">
              ...
              <div className="mt-8 flex items-center gap-2">
                <div className="text-sm font-medium">213 people joined</div>
