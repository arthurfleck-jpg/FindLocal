...
const WhyChooseUs = () => {
  ...
  return <section id="why-choose-us" className="section-padding relative">
      ...
      <div className="container mx-auto container-padding relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-10">
          {advantages.map((advantage, index) => <div key={index} className="flex space-x-4 items-start">
        ...
        <div className="mt-20 bg-gray-50 rounded-2xl p-8 md:p-10 shadow-sm">
          <div className="flex flex-col md:flex-row gap-8 items-center">
            <div className="w-24 h-24 rounded-full overflow-hidden flex-shrink-0">
              <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=256&q=80" alt="Sarah Chen" className="w-full h-full object-cover" />
            </div>
            <div>
              ...
              <p className="text-lg md:text-xl italic text-gray-700 mb-4">&quot;Having FindLocal's help during my first trip to Beijing was invaluable. From getting me set up with WeChat Pay to translating at restaurants and helping me navigate the subway, my guide made what could have been an overwhelming experience actually enjoyable!&quot;</p>
              <div>
